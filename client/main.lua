...
RegisterNetEvent('Yhdyskuntapalvelus:client:startservice', function(amount, state)
    calledpolice = false
...
RegisterNetEvent('Yhdyskuntapalvelus:client:stopservice', function()
    jobdone()
end)
...
function jobdone()
    ...
    startedtask = false
    TriggerServerEvent('Yhdyskuntapalvelus:server:jobDone')
