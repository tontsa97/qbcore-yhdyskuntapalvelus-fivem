...
Config.commando = 'Yhdyskuntapalvelus'
Config.endcommando = 'lopetayhdyskuntapalvelu'
...
Config.markercolor = {
    r = 0,
    g = 255, -- Changed to green
    b = 0,
}

Config.policestation = vector3(438.69, -981.88, 30.69)
Config.tasks = {
    [1] = {
        task = 1,
        text3d = 'Aloita puhdistus',
        tasktime = 5, -- seconds
        progresstext = 'Puhdistus..',
        locations = {
    ...
    [2] = {
        ...
        text3d = 'Ota laatikko',
        tasktime = 5, -- seconds
        progresstext = 'Otetaan laatikkoa..',
        locations = {
    ...
    [3] = {
        task = 3,
        text3d = 'Puhdista kakka',
        tasktime = 5, -- seconds
        progresstext = 'Puhdistetaan kakkaa..',
        locations = {
    ...
    [5] = {
        task = 5,
        text3d = 'Aloita siivous',
        tasktime = 5, -- seconds
        progresstext = 'Siivotaan..',
        locations = {
